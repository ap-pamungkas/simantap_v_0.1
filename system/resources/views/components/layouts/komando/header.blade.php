									...
									<div class="widget-reminder-content">
										...
										<div class="d-flex align-items-center mt-2">
											<div class="flex-fill d-flex align-items-center">
												<img src="{{ url('public/komando') }}/assets/img/user/user-3.jpg" alt="" width="16" class="me-2"> Richard Leong
											</div>
							...
							<div data-scrollbar="true" class="h-200px card-body fs-10px">
								<div class="widget-chat">
									<div class="widget-chat-item">
										<div class="widget-chat-media"><img src="{{ url('public/komando') }}/assets/img/user/user-2.jpg" alt="" /></div>
									...
									<div class="widget-chat-item">
										<div class="widget-chat-media"><img src="{{ url('public/komando') }}/assets/img/user/user-3.jpg" alt="" /></div>
										<div class="widget-chat-content">
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link d-flex align-items-center">
						<div class="menu-img online me-sm-2 ms-lg-0 ms-n2">
							<img src="{{ url('public/komando') }}/assets/img/user/profile.jpg" alt="Profile" class="" />
						</div>
						<div class="menu-text d-sm-block d-none">
							<span class="d-block"><span><span class="__cf_email__" data-cfemail="01545244534f404c4441464c40484d2f424e4c">[email&#160;protected]</span></span></span>
						</div>
					</a>
