                        ...
                        <tbody>
                            @forelse ($list_devices as $index => $devices)
                                <tr>
                                    ...
                                    <td><img width="100px" src="{{ url("system/storage/app/public/".$devices->qr_code) }}" alt=""></td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-secondary btn-sm" wire:click="updateConditions({{ $devices->id }})" data-bs-toggle="modal" data-bs-target="#tambah">
                                            <i class="bi bi-pencil-square"></i> Ubah Kondisi
                                        </button>
                                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus{{ $devices->id }}">
                                ...
                                <!-- Modal Hapus Data -->
                                <x-modals.modalhapus id="hapus{{ $devices->id }}" click="deleteData({{ $devices->id }})" />
                            @empty
                                <tr>
